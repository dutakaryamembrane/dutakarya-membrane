      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8 rounded-3xl bg-white p-8 shadow-sm">
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            ...
            <div className="flex flex-wrap items-center justify-start gap-3 pb-1 md:justify-end">
              <Link
                href="/admin/projects/new"
                className="inline-flex h-11 items-center justify-center whitespace-nowrap rounded-full border border-black/10 bg-white px-5 text-sm font-medium text-[#171717] transition-all duration-200 hover:border-[#b89452] hover:bg-[#b89452] hover:text-white"
              >
                New Project
              </Link>
